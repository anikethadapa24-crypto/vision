...
| Doc | What it answers |
|---|---|
| [`PRD.md`](./PRD.md) | What are we building, for whom, and why does it matter |
| [`ARCHITECTURE.md`](./ARCHITECTURE.md) | What services exist, how they talk to each other, where data lives on disk |
| [`ROADMAP.md`](./ROADMAP.md) | What order we build it in, milestone by milestone, and how we'll know each one is done |
| [`UI.SPEC.md`](./UI.SPEC.md) | Every screen, design token, and component the front end is built from |
| [`TASKS.md`](./TASKS.md) | The actual granular work queue we're pulling from right now |
